...
public class Groovy {
    ...
    public static void main(String[] args) {
        ...
        String script = "import com.jayway.restassured.RestAssured; def hello(param1,param2) {System.out.println(\"xxxxxxxxxx\"); return \"the params is $param1 and $param2\"}";
        String scriptTwo = "    import com.alibaba.fastjson.*\n" +
                "    def process(json){\n" +
                "        JSONObject j = JSON.parseObject(json);\n" +
                "        return JSON.toJSONString(j);\n" +
                "    }";
        Object res1 = groovy.runGroovyScript(scriptTwo, "process", new String[] { "{}"});
